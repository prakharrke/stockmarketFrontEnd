...
export default class SignUpForm extends Component {
	...
	signUp(event) {
		...
		axios.post(Constants.url + 'SignUp', `userDetails=${JSON.stringify({ username: this.state.username, password: this.state.password })}`, {
					...
					<div className="card">
						<div className="card-block">
							<form className="k-form">
								...
								<input type="button" className="k-button k-primary" value="Sign Up" onClick={this.signUp.bind(this)} />
							</form>
						</div>
					</div>
